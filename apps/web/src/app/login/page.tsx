    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold tracking-tight">ApplyMe</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Job matcher &amp; assisted apply for Canada&nbsp;🍁
          </p>
        </div>

        <div className="rounded-xl border border-border bg-card p-6 shadow-sm space-y-3">
          <a href={`${API_BASE}/auth/google`} className="block">
          ...
          <a href={`${API_BASE}/auth/github`} className="block">
            <Button variant="outline" className="w-full gap-2.5">
